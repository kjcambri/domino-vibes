...
export function MyHandPreview({
  ...
  return (
    <GameCard className="border-gold-300/22 bg-[radial-gradient(circle_at_18%_0%,rgba(242,193,78,0.12),transparent_16rem),linear-gradient(180deg,rgba(107,63,29,0.46),rgba(6,31,24,0.9)_58%,rgba(42,22,10,0.78))] p-4 shadow-[0_-16px_42px_rgba(42,22,10,0.32)]" variant="wood">
      ...
      <div className="-mx-2 mt-4 flex snap-x gap-3 overflow-x-auto rounded-3xl border border-gold-200/18 bg-[radial-gradient(circle_at_50%_0%,rgba(255,244,214,0.1),transparent_13rem),linear-gradient(180deg,rgba(20,107,74,0.58),rgba(11,61,46,0.62)_52%,rgba(42,22,10,0.4))] px-3 pb-5 pt-5 shadow-[inset_0_1px_0_rgba(255,244,214,0.18),inset_0_-14px_30px_rgba(0,0,0,0.24),0_12px_28px_rgba(0,0,0,0.18)] [scrollbar-width:thin]">
        {hand?.tiles.map((tile) => {
