-- Sprint 9 patch: separate board lanes.
-- Right chain: right -> down -> left. Left chain: left -> up -> right.
-- Each vertical lane holds two placements before turning horizontally.
